...
Original file is located at
    https://colab.research.google.com/drive/1HreCzDaz5hPr5w2mxeQuMdoVWIev89CK
"""
...
# sentences = ['hello world', 'this is a test', 'are you ready yes']

word_list = list(set(" ".join(sentences).split()))
# ['ready', 'hello', 'yes', 'world', 'you', 'test', 'are', 'this', 'is', 'a']

word2idx = {'[PAD]':0,'[CLS]':1,'[SEP]':2,'[MASK]':3}
for i,w in enumerate(word_list):
  word2idx[w] = i + 4
# {'[PAD]': 0,'[CLS]': 1,'[SEP]': 2,'[MASK]': 3,'ready': 4,'hello': 5,'yes': 6,'world': 7,'you': 8,'test': 9,'are': 10,'this': 11,'is': 12,'a': 13}
...
def make_data():
  batch = []
  postive = negtive = 0
  while postive != batch_size / 2 or negtive != batch_size / 2:
    # 随机选择两个句子
    ...
    if tokens_a_index + 1 == tokens_b_index and postive < batch_size / 2:
      batch.append([input_ids, segment_ids,masked_tokens,masked_pos,True])
      postive += 1

    elif tokens_a_index + 1 != tokens_b_index and negtive < batch_size / 2:
